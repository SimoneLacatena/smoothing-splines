...
<p>La LOOCV  può essere interpretata come una somma dei residui quadtrati *pesata*  dove i pesi hanno della forma $w_i = \frac{1}{(1 - \{S_\lambda\}_{ii})^2}$, dato che $\{S_\lambda\}_{ii}$ è diverso per ogni osservazione, il criterio da un peso diverso ad ogni osservazione.
Un miglioramento della LOOCV è la Generalized Cross-Validation (GCV) che permette di equilibrare il peso delle diverse osservazioni, questo criterio trova il valore di $\lambda$ che miniminzza</p>
