...
## Splines 
<p>Invece di adattare un polinomio di grado elevato su l'intero intervallo, l'idea base dell'approccio Spline è quello di utilizzare la **regressione polinomiale a tratti** che comporta la divisione dell'intervallo dei valori della variabile predittrice $X$ in sottointervalli e l'inserimento di polinomi di grado inferiore sui diversi sottointervalli.</p>
...
aggiungere tre vincoli: la **funzione deve essere continua** ,e  la **derivata prima e seconda dei polinomi a tratti devono essere continue**, in questo modo non solo il polinomio a tratti sarà continuo ma sarà anche smussato. Ad ogni vincolo  il numero di gradi di libertà si riduce di 1 , in questo modo i gradi libertà del polinomio di grado 3 visto prima si riducono a 5. In generale una spline cubica con $K$ nodi utilizza $K+4$ gradi di libertà.</p>

<p>Quindi, una **spline di ordine** $d$ con nodi $c_j$, $j=1,...,K$ è un polinomio a tratti di ordine $d$ che ha derivate continue sino all' ordine $d-1$. Una spline cubica è in questo modo due volte differenziabile nell'intero intervallo, questo tipo di spline sono le più utilizzate poichè risulta  difficile individuare la discontinuità ai nodi.
